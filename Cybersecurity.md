...
Fun. 
Framework for critical infrastructure cybersecurity by Institute of Standard and technologies helps executives to get involved especially in the human aspect in predicting social engineering hacks.

Software Vulnerabilities
Code Review as a control.
How to use buffer overflow vulnerabilities?

SCADA Supervisory Control and Data Acquisition Systems. Gas Pipeline, oil refinery. Standard vendor operating systems with additional vulnerabilities well known.

When they ask you what role do you want to play.
Here's a guideline from US Nise framework, since Sg mainly copies.

Operate/Maintain. Security provision.Analyse. Protect and Defend.
Oversee and govern.Investigation.one more unlisted. 7 path.

# Vendor neutral certification #
Security + by comptia
CISSP career ladder.in field for 5 years.
More general is CISM Certified security manager.
CISA auditor. CIPP privacy professional

When you first enter, you may get feeder role like software developer.
Get a mentor. Interdisciplinary. From science to sociology
